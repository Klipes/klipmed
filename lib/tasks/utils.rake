namespace :utils do
  ...
  task setup: :environment do
    ...
    puts '==============================================================================================='
    puts "rake log:clear... #{%x(rake log:clear)}"
    ...
    puts '==============================================================================================='
    puts "rake utils:generate_companies...#{%x(rake utils:generate_companies)}"
    puts "rake utils:generate_covenants...#{%x(rake utils:generate_covenants)}"
    puts "rake utils:generate_payment_methods...#{%x(rake utils:generate_payment_methods)}"
    puts "rake utils:generate_users...#{%x(rake utils:generate_users)}"
    puts "rake utils:generate_receivable_categories...#{%x(rake utils:generate_receivable_categories)}"
    puts "rake utils:generate_payable_categories...#{%x(rake utils:generate_payable_categories)}"
    puts "rake utils:generate_customers...#{%x(rake utils:generate_customers)}"
    puts "rake utils:generate_suppliers...#{%x(rake utils:generate_suppliers)}"
    puts "rake utils:generate_receivables...#{%x(rake utils:generate_receivables)}"
    puts "rake utils:generate_payables...#{%x(rake utils:generate_payables)}"
    puts "rake utils:generate_schedules...#{%x(rake utils:generate_schedules)}"
    puts '==============================================================================================='
    puts 'Setup finished!'
  end
